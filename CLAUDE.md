...
When confidence in the change is 90% or higher after this trace, push automatically without asking.
If confidence is below 90%, stop and report what's uncertain before pushing.
